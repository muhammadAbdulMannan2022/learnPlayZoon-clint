    ...
    <div className="p-5 flex items-start justify-center flex-wrap gap-2">
      <div className="card w-96 bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          <p>
            ...
            An access token is like a key. If you have the key, you can open the
            lock in this scene. If you have access token you can get data if you
            don't you will not get any data. <br />
      ...
      <div className="card w-96 bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          MongoDB's Aggregation Framework is a powerful tool for processing and
          analyzing data in MongoDB. It allows you to perform complex data
          ...
          The Aggregation Framework operates on the concept of a pipeline, which
          consists of multiple stages that are applied sequentially to the data.
          Each stage performs a specific operation on the input data and passes
          the modified data to the next stage. <br /> example : Pipeline Stages
